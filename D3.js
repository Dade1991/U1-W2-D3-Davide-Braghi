const starWarsCharacters = [
  {
    name: "Luke Skywalker",
    height: 172,
    mass: 201, //modified this mass. was= 277
    hair_color: "blond",
    skin_color: "fair",
    eye_color: "blue",
    birth_year: "19BBY",
...
console.log("the total mass is " + crewMass)
...
// Ho cambiato la mass del personaggio a riga 5 (era 277), cambiano la massa totale ed il messaggio di carico.
...
const randomCharacterIndex = Math.floor(Math.random() * 10)
const chosenCharacter = starWarsCharacters[randomCharacterIndex]

console.log(chosenCharacter)

const message =
  "My favorite character in Star Wars Saga is " +
  starWarsCharacters[0].name +
  ". " +
  "He has an height of " +
  starWarsCharacters[0].height +
  ", eyes color " +
  starWarsCharacters[0].eye_color +
  ", hair color " +
  starWarsCharacters[0].hair_color +
  ", skin color " +
  starWarsCharacters[0].skin_color +
  " and a mass of " +
  starWarsCharacters[0].mass +
  " kgs." +
  " He was born in " +
  starWarsCharacters[0].birth_year +
  " and he is a " +
  starWarsCharacters[0].gender +
  "."
